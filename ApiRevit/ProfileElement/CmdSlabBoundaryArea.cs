...
namespace ApiRevit.ProfileElement
{
   ...
   public class CmdSlabBoundaryArea : IExternalCommand
    {
        ...
        public Result GetPlanarFaceOuterLoops(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            List<List<XYZ>> polygons = CmdSlabBoundary.GetFloorBoundaryPolygons(floors, opt);
            List<List<UV>> flat_polygons = Flatten(polygons);
