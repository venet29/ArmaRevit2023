...
namespace ApiRevit.ProfileElement
{
   ...
   public class CmdSlabBoundary : IExternalCommand
    {
        /// <summary>
        ...
        static bool GetBoundary(List<List<XYZ>> polygons, Solid solid)
        {
        ...
        /// </summary>
        static public List<List<XYZ>> GetFloorBoundaryPolygons(List<Element> floors, Options opt)
        {
