...
namespace ArmaduraLosaRevit.Model.Bim.AcotarPAsada.WPF_Pasada
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<UI_AcotarPasadasNH>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, UI_AcotarPasadasNH ui)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_AcotarPasada.M1_CrearCopiaLocal(ui, uiApp);
