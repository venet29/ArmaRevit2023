...
{
    public class AcotarArribaIzq : BaseAcotar, IAcotarCasos
    {

        public AcotarArribaIzq(UIApplication uiapp, EnvoltoriPasada envoltoriPasada, DimensionType _dimensionType) : base(uiapp, envoltoriPasada, _dimensionType)
        {
        ...
        public bool Ejecutar()
        {
            try
            {
                ...
                if (result)
                {
                    ...
                    line_grid = Line.CreateBound(ptoInter.Redondear(6), P1.Redondear(6));
