...
{
    public class AcotarIzqSup : BaseAcotar, IAcotarCasos
    {

        public AcotarIzqSup(UIApplication uiapp, EnvoltoriPasada envoltoriPasada, DimensionType _dimensionType) : base(uiapp, envoltoriPasada, _dimensionType)
        {
