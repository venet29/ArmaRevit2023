...
{
    public class AcotarBajoIzq : BaseAcotar, IAcotarCasos
    {

        public AcotarBajoIzq(UIApplication uiapp, EnvoltoriPasada envoltoriPasada, DimensionType _dimensionType) : base(uiapp, envoltoriPasada, _dimensionType)
        {
