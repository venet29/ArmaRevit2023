...
namespace ArmaduraLosaRevit.Model.Bim.BimWorkSet.WPF_WorkSet
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<UI_WorkSetNH>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, UI_WorkSetNH ui)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_WorkSetNH.M1_CrearCopiaLocal(ui, uiApp);
