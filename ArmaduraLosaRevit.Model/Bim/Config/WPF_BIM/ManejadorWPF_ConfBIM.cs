...
namespace ArmaduraLosaRevit.Model.Bim.Config.WPF_BIM
{
    ...
    public class ManejadorWPF_ConfBIM
    {


        // ModelessForm instance
        private UI_ConfBIM _mMyForm;
        private UIApplication _UIapp;

        public ManejadorWPF_ConfBIM(UIApplication _uiapp)
        {
            _UIapp = _uiapp;
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new UI_ConfBIM(_UIapp, evStr, evWpf);
