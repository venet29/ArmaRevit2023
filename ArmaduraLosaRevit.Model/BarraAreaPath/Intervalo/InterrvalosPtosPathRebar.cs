...
namespace ArmaduraLosaRevit.Model.BarraAreaPath.Intervalo
{
    public class InterrvalosPtosPathRebar
    {
        ...
        {
            ptIni = ptIni - _dIreccionMuroEnIgualSentidoRightDirection * Util.MmToFoot(_datosMallasDTO.diametroH);
            ptFin = ptFin + _dIreccionMuroEnIgualSentidoRightDirection * Util.MmToFoot(_datosMallasDTO.diametroH);
        }
