...
namespace ArmaduraLosaRevit.Model.BarraAreaPath.WPFm
{
    ...
    public class ManejadorWPF_Malla
    {
      
        // ModelessForm instance
        private Ui_Malla _mMyForm;
        private UIApplication _uiapp;

        public ManejadorWPF_Malla(ExternalCommandData commandData)
        {
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new Ui_Malla(uiapp, evStr, evWpf);
