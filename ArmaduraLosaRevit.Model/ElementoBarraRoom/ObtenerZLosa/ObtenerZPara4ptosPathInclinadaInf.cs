...
{
    public class ObtenerZPara4ptosPathInclinadaInf : IObtenerZPara4ptosPath
    {
...
#pragma warning disable CS0169 // The field 'ObtenerZPara4ptosPathInclinadaInf.CoordZFaceInferior' is never used
        private double CoordZFaceInferior;
#pragma warning restore CS0169 // The field 'ObtenerZPara4ptosPathInclinadaInf.CoordZFaceInferior' is never used

        public ObtenerZPara4ptosPathInclinadaInf(UIApplication uiapp, List<XYZ> listaPtos, PlanarFace face)
        {
            this._uiapp = uiapp;
            ...
            _buscarPtoProyeccionEnLosaInclinada =
               new BuscarPtoProyeccionEnLosaInclinada(uiapp, face.FaceNormal,face.Origin);
