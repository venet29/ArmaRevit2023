...
{
    public class BarraF20a : BarraBase, ICasoBarra
    {

        private BarraRoom _barraRoom;

        public BarraF20a(BarraRoom barraRoom, SolicitudBarraDTO _solicitud, DatosNuevaBarraDTO _datosNuevaBarra) : base(barraRoom, _solicitud, _datosNuevaBarra)
        {
        ...
        private void FactoresParaParametrosLargoEspacificosBarra()
        {
            ...
            DesplazamientoLargoBarraSecundaria = (_datosNuevaBarra.dimBarras._LargoAhorro_Dere_ > 0 ? _datosNuevaBarra.dimBarras._LargoAhorro_Dere_ : _datosNuevaBarra.dimBarras._LargoAhorro_Izq_);
        }
    }
}
