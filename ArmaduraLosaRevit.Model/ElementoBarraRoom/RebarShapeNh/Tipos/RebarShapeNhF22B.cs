...
{
    internal class RebarShapeNhF22B : RebarShapeNhBase,IRebarShapeNh
    {
        private bool IsRebarShapeSinInvertir;

        public RebarShapeNhF22B(UIApplication uiapp, SolicitudBarraDTO solicitudDTO, DatosNuevaBarraDTO datosNuevaBarraDTO, PathSymbol_REbarshape_FxxDTO _rEbarShapeNHFXXDTO) : base(uiapp,  solicitudDTO, datosNuevaBarraDTO, _rEbarShapeNHFXXDTO)
        {
        ...
        public bool M1_PreCAlculos()
        {
            try
            {
                ...
                TiposRebarShape_largoAhorroRedondeo5_Alt.ObtenerLargoAhorroIZq5_Alt(_AyudaLargoPath.LargoPathreiforment, _AyudaLargoPath.LargoAhorroIzq);
                ...
                dimBarrasAlternativa = new DimensionesBarras(a: TiposRebarShape_largoAhorroRedondeo5_Alt. largo5_AltIzq, b: 0, c: 0,c2:0, d: 0, e: 0, g: 0, largo2: TiposRebarShape_largoAhorroRedondeo5_Alt.largo5_AltIzq, caso: "RebarShapeNh", LetrasCambiosEspesor: "");


                dimBarras_parameterSharedLetras = new DimensionesBarras(a: _AyudaLargoPath.LargoPathreiforment, b: 0, c: 0, c2: TiposRebarShape_largoAhorroRedondeo5_Alt.largo5_AltIzq, d: 0, e: 0, g: 0, largo2: TiposRebarShape_largoAhorroRedondeo5_Alt.largo5_AltIzq, caso: "RebarShapeNh", LetrasCambiosEspesor: "");
