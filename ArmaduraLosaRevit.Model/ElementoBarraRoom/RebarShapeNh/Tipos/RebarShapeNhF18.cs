...
{
    internal class RebarShapeNhF18 : RebarShapeNhBase, IRebarShapeNh
    {

        public RebarShapeNhF18(UIApplication uiapp, SolicitudBarraDTO solicitudDTO, DatosNuevaBarraDTO datosNuevaBarraDTO, PathSymbol_REbarshape_FxxDTO _rEbarShapeNHFXXDTO)
        ...
        public bool M1_PreCAlculos()
        {
            try
            {
                ...
                //para guardar datos internos
                string aux_Letracambiar = TipoLetraCambiar.ObtenerLetra("f18");
