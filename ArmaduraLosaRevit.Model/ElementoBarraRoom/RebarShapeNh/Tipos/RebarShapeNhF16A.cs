...
{
    internal class RebarShapeNhF16A : RebarShapeNhBase, IRebarShapeNh
    {

        public RebarShapeNhF16A(UIApplication uiapp, SolicitudBarraDTO solicitudDTO,DatosNuevaBarraDTO datosNuevaBarraDTO, PathSymbol_REbarshape_FxxDTO pathSymbol16ADTO):base(uiapp, solicitudDTO, datosNuevaBarraDTO, pathSymbol16ADTO)
        {
        }
