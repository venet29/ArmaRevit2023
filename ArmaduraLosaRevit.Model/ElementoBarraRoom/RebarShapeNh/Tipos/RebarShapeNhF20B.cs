...
{
    internal class RebarShapeNhF20B : RebarShapeNhBase,IRebarShapeNh
    {
        public RebarShapeNhF20B(UIApplication uiapp, SolicitudBarraDTO solicitudDTO, DatosNuevaBarraDTO datosNuevaBarraDTO, PathSymbol_REbarshape_FxxDTO _rEbarShapeNHFXXDTO) : base(uiapp, solicitudDTO,datosNuevaBarraDTO, _rEbarShapeNHFXXDTO)
        {
        ...
        public bool M1_PreCAlculos()
        {
            try
            {
               ...
               // double largoAltenativa = _AyudaLargoPath.LargoPathreiforment - _AyudaLargoPath.LargoAhorroDere;// + LargoPaTa + _EspesorLosa_EnFoot;
                ...
                //para guardar datos internos            
                dimBarras_parameterSharedLetras = new DimensionesBarras(a: _AyudaLargoPath.LargoPaTa, b: _AyudaLargoPath._EspesorLosa_EnFoot, c: _AyudaLargoPath.LargoPathreiforment, c2: TiposRebarShape_largoAhorroRedondeo5_Alt.largo5_AltIzq, d: 0, e: 0, g: 0, largo2: auxLargo2, caso: "RebarShapeNh", LetrasCambiosEspesor: "B_");
