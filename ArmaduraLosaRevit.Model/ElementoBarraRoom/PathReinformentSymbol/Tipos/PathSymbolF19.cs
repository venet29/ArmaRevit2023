...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.PathReinforment.Tipos
{
    ...
    class PathSymbolF19 : ChangeFamilyPathReinforceSymbol, IPathSymbol
    {
        protected PathSymbol_REbarshape_FxxDTO pathSymbolFXXADTO;
        protected List<ParametroNewTipoPathSymbol> ListaTipoFamilia_conpata;
        protected PathReinforceSymbolDTO _PSD_eIzq;
        protected PathReinforceSymbolDTO _PSD_eDere;
        protected PathReinforceSymbolDTO _PSD_entre;

        public PathSymbolF19(UIApplication uiapp, DatosNuevaBarraDTO _DatosNuevaBarraDTO, PathSymbol_REbarshape_FxxDTO _PathSymbolF20ADTO) : base(uiapp, _DatosNuevaBarraDTO)
        {
        ...
        public virtual bool M1_ObtenerPArametros()
        {
            try
            {
                M1_1_OtenerPArametrosBAsePOrescala();

                double largopata_foot = (pathSymbolFXXADTO.pataIzq_foot == 0 ? _datosNuevaBarraDTO.LargoPataFoot() : pathSymbolFXXADTO.pataIzq_foot);
                ...
                PathReinforceSymbolDTO _pDS_DesDereInf = new PathReinforceSymbolDTO("DesIzqInf",( (pathSymbolFXXADTO.DesIzqInf_foot>0?pathSymbolFXXADTO.DesIzqInf_foot + ConstNH.CONST_EXTRADESDFASE_FOOT:0)) / _scaleView);
                ...
                nombreFamiliaCOnPata = nombreFamiliaCOnPata + "_D" + Util.FootToCm(pathSymbolFXXADTO.DesDereSup_foot).ToString();
        ...
        protected void M1_1_OtenerPArametrosBAsePOrescala()
        {
            double eIzq = 18;
            double eDere = 18;
            double entre = 20;
