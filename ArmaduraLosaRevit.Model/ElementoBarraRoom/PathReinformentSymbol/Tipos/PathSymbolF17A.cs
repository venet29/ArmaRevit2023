...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.PathReinforment.Tipos
{
    ...
    class PathSymbolF17A : ChangeFamilyPathReinforceSymbol, IPathSymbol
    {
        ...
        public PathSymbolF17A(UIApplication uiapp, DatosNuevaBarraDTO _DatosNuevaBarraDTO, PathSymbol_REbarshape_FxxDTO _PathSymbolF20ADTO) : base(uiapp, _DatosNuevaBarraDTO)
        {
        ...
        public bool M1_ObtenerPArametros()
        {
            try
            {
                ...
                nombreFamiliaCOnPata = nombreFamiliaCOnPata + "_D" + Util.FootToCm(DesDereInf_foot).ToString();
