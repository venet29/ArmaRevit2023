...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.PathReinforment.Tipos
{
    ...
    class PathSymbolF21B : ChangeFamilyPathReinforceSymbol, IPathSymbol
    {
        ...
        public PathSymbolF21B(UIApplication uiapp, DatosNuevaBarraDTO _DatosNuevaBarraDTO, PathSymbol_REbarshape_FxxDTO _PathSymbolF20ADTO) : base(uiapp, _DatosNuevaBarraDTO)
        {
        ...
        public bool M1_ObtenerPArametros()
        {
            try
            {
                ...
                if (!Util.IsSimilarValor(largopata_foot, pathSymbolFXXADTO.DesIzqInf_foot, 0.001))
                {
                    nombreFamiliaCOnPata = nombreFamiliaCOnPata + "_D" + Util.FootToCm(pathSymbolFXXADTO.DesIzqInf_foot).ToString();
                }
