...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.PathReinforment.Tipos
{
    ...
    class PathSymbolF11A : ChangeFamilyPathReinforceSymbol, IPathSymbol
    {
...
#pragma warning disable CS0169 // The field 'PathSymbolF11A._PSD_eDere' is never used
        private PathReinforceSymbolDTO _PSD_eDere;
#pragma warning restore CS0169 // The field 'PathSymbolF11A._PSD_eDere' is never used
#pragma warning disable CS0169 // The field 'PathSymbolF11A._PSD_entre' is never used
        private PathReinforceSymbolDTO _PSD_entre;
#pragma warning restore CS0169 // The field 'PathSymbolF11A._PSD_entre' is never used

        public PathSymbolF11A(UIApplication uiapp, SolicitudBarraDTO solicitudDTO, DatosNuevaBarraDTO _DatosNuevaBarraDTO, PathSymbol_REbarshape_FxxDTO _PathSymbolF20ADTO) : base(uiapp, _DatosNuevaBarraDTO)
        {
        ...
        public bool M1_ObtenerPArametros()
        {
            try
            {
                ...
                double Valor25Foot = Util.CmToFoot(20);// pogo cero para que cambia las patas para todos los casos

               if (!Util.IsSimilarValor(pathSymbolFXXADTO.EspIzq_foot, Valor25Foot, 0.01))
                {
            ...
            {
                Util.ErrorMsg($"Error al obtener 'PathSymbolF11A'  \n ex:{ex.Message}");
                return false;
            }
            return true;
        }
