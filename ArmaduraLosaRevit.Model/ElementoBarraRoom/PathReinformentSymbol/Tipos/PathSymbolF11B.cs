...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.PathReinforment.Tipos
{
    ...
    class PathSymbolF11B : ChangeFamilyPathReinforceSymbol, IPathSymbol
    {
...
#pragma warning disable CS0169 // The field 'PathSymbolF11B._PSD_eIzq' is never used
        private PathReinforceSymbolDTO _PSD_eIzq;
#pragma warning restore CS0169 // The field 'PathSymbolF11B._PSD_eIzq' is never used
        private PathReinforceSymbolDTO _PSD_eDere;
#pragma warning disable CS0169 // The field 'PathSymbolF11B._PSD_entre' is never used
        private PathReinforceSymbolDTO _PSD_entre;
#pragma warning restore CS0169 // The field 'PathSymbolF11B._PSD_entre' is never used

        public PathSymbolF11B(UIApplication uiapp, SolicitudBarraDTO solicitudDTO, DatosNuevaBarraDTO _DatosNuevaBarraDTO, PathSymbol_REbarshape_FxxDTO _PathSymbolF20ADTO) : base(uiapp, _DatosNuevaBarraDTO)
        {
        ...
        public bool M1_ObtenerPArametros()
        {
            try
            {
                ...
                if (!Util.IsSimilarValor(pathSymbolFXXADTO.EspDere_foot, Valor25Foot, 0.01))
                {
