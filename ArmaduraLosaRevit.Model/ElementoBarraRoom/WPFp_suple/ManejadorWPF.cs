...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.WPFp_suple
{
    ...
    public class ManejadorWPFSuple 
    {
      
        // ModelessForm instance
        private Ui_barraSuple _mMyForm;
        private UIApplication _UIapp;

        public ManejadorWPFSuple(ExternalCommandData commandData)
        {
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new Ui_barraSuple(uiapp, evStr, evWpf);
