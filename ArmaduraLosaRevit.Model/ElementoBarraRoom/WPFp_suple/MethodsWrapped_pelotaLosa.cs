...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.WPFp_suple
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<Ui_barraSuple>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, Ui_barraSuple ui_pelotaLosa)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_barraSuple.M1_EjecutarRutinas(ui_pelotaLosa, uiApp);
