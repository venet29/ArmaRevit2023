...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.Tag.Servicio.WPF_EText
{
    ...
    /// </summary>
    public partial class Ui_EditarTExtoPath : Window, INotifyPropertyChanged
    {
        ...
        public Ui_EditarTExtoPath(UIApplication uiApp, EventHandlerWithStringArg evExternalMethodStringArg,
        ...
        private void BExternalMethod1_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (ImageOprimido != "f1_suple" || ImageOprimido != "btnCerrar_var")
            {
