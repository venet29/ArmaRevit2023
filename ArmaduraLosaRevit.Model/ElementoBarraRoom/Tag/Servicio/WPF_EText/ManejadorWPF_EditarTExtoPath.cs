...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.Tag.Servicio.WPF_EText
{
    ...
    public class ManejadorWP_EditarTExtoPath
    {
      
        // ModelessForm instance
        private Ui_EditarTExtoPath _mMyForm;
        private UIApplication _UIapp;

        public ManejadorWP_EditarTExtoPath(UIApplication _uiapp)
        {
            _UIapp = _uiapp;
        }
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new Ui_EditarTExtoPath(uiapp, evStr, evWpf);
