...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.Tag.Servicio.WPF_EText
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<Ui_EditarTExtoPath>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, Ui_EditarTExtoPath ui_pelotaLosa)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_EditarTExtoPath.M1_EjecutarRutinas(ui_pelotaLosa, uiApp);
