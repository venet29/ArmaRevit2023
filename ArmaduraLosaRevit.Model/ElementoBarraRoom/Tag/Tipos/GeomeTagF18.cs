...
{
    public class GeomeTagF18 : IGeometriaTag
    {
        ...
        GeomeTagF11A _geomeTagF4_Superior;
        GeomeTagF11A _geomeTagF4_Inferior;
        private double anguloBarra;

        public GeomeTagF18(Document doc, XYZ ptoMOuse, List<XYZ> listaPtosPerimetroBarras, SolicitudBarraDTO _solicitudBarraDTO)
        {
            this._doc = doc;
        ...
        public bool Ejecutar(GeomeTagArgs args)
        {
            ...
            {
                Util.ErrorMsg($"Error ejecutar TagF18  ex:${ex.Message}");
                return false;
            }
            return true;
        ...
        public bool M1_ObtnerPtosInicialYFinalDeBarra(double anguloRoomRad)
        {
            try
            {
                ...
                _geomeTagF4_Superior = new GeomeTagF11A(_doc, ptoMOuse_supero, _listaPtosPerimetroBarras, _solicitudBarraDTO);
        ...
        public void M3_DefinirRebarShape()
        {
            ...
            GeomeTagF11AAlterna _GeomeTagF11aAlterna = new GeomeTagF11AAlterna(_doc, _solicitudBarraDTO) { };
            _GeomeTagF11aAlterna.Ejecutar(new GeomeTagArgs() { angulorad = anguloBarra });
            _geomeTagF4_Superior._ubicacionEnlosa = M3_1_InvertirUbicacionEnLOsa_F4Superior(_geomeTagF4_Superior._ubicacionEnlosa);
            _geomeTagF4_Superior.M5_DefinirRebarShapeAhorro(_GeomeTagF11aAlterna.AsignarPArametros);
