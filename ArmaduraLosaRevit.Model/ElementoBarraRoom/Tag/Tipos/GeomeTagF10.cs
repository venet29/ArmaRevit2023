...
{
    public class GeomeTagF10 : GeomeTagBase, IGeometriaTag
    {
        public GeomeTagF10(Document doc, XYZ ptoMOuse, List<XYZ> listaPtosPerimetroBarras, SolicitudBarraDTO _solicitudBarraDTO) :
        ...
        public bool Ejecutar(GeomeTagArgs args)
        {
            ...
            {
                Util.ErrorMsg($"Error ejecutar TagF10  ex:${ex.Message}");
                return false;
            }
            return true;
        ...
        public void M3_DefinirRebarShape()
        {
            ...
            listaTag.RemoveAll(c => c.nombre == "A");
            XYZ p0_A = Util.ExtenderPuntoRespectoOtroPtosConAngulo(_p1, _anguloBarraRad, Util.CmToFoot(-12), Util.CmToFoot(-10));
            ...
            XYZ p0_B = Util.ExtenderPuntoRespectoOtroPtosConAngulo(_ptoMouse, _anguloBarraRad, Util.CmToFoot(-45), Util.CmToFoot(-9));
            ...
            XYZ p0_C = Util.ExtenderPuntoRespectoOtroPtosConAngulo(_p2, _anguloBarraRad, Util.CmToFoot(13), Util.CmToFoot(-10));
            TagP0_C = M1_1_ObtenerTAgPathBarra(p0_C, "C", "M_Path Reinforcement Tag(ID_cuantia_largo)_C_" + escala + "_" + _signoAngulo + Math.Abs(_anguloBArraGrado).ToString(), escala);
        ...
        public void M5_DefinirRebarShapeAhorro(Action<GeomeTagF10> rutina)
        {
            rutina(this);
        }
