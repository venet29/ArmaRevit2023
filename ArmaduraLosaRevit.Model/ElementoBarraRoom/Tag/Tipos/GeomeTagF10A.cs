...
{
    public class GeomeTagF10A : GeomeTagBase, IGeometriaTag
    {
        public GeomeTagF10A(Document doc, XYZ ptoMOuse, List<XYZ> listaPtosPerimetroBarras, SolicitudBarraDTO _solicitudBarraDTO) :
        ...
        public bool Ejecutar(GeomeTagArgs args)
        {
            ...
            {
                Util.ErrorMsg($"Error ejecutar TagF10A  ex:${ex.Message}");
                return false;
            }
            return true;
        ...
        public void M5_DefinirRebarShapeAhorro(Action<GeomeTagF10A> rutina)
        {
            rutina(this);
        }
