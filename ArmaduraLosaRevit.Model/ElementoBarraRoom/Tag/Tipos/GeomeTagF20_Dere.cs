...
{
    public class GeomeTagF20_Izq : GeomeTagBaseAhorro,  IGeometriaTag
    {

        public GeomeTagF20_Izq(Document doc, XYZ ptoMOuse, List<XYZ> listaPtosPerimetroBarras, SolicitudBarraDTO _solicitudBarraDTO)
