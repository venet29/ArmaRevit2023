...
{
    public class GeomeTagF20 : IGeometriaTag
    {
        ...
        public GeomeTagF20(Document doc, XYZ ptoMOuse, List<XYZ> listaPtosPerimetroBarras, SolicitudBarraDTO _solicitudBarraDTO)
        {
            this._doc = doc;
        ...
        public bool Ejecutar(GeomeTagArgs args)
        {
            ...
            {
                Util.ErrorMsg($"Error ejecutar TagF20  ex:${ex.Message}");
                return false;
            }
            return true;
        ...
        public void M3_DefinirRebarShape()
        {
            ...
            _geomeTagF4_Superior._ubicacionEnlosa = _geomeTagF4_Superior._ubicacionEnlosa;// M3_1_InvertirUbicacionEnLOsa_F3Superior(_geomeTagF3_Superior._ubicacionEnlosa);
