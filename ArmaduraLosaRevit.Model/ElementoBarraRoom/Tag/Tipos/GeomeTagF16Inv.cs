...
{
    public class GeomeTagF16Inv : IGeometriaTag
    {
        ...
        public GeomeTagF16Inv(Document doc, XYZ ptoMOuse, List<XYZ> listaPtosPerimetroBarras, SolicitudBarraDTO _solicitudBarraDTO)
        {
            this._doc = doc;
