...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.WPF_pathSymbol
{
    ...
    internal class Methods_Ui_pathSymbol
    {
        /// <summary>
        ...
        public static void M1_DocumentEditPAth(Ui_pathSymbol ui, UIApplication _uiapp)
        {
            ...
            string NombrebotonOprimido = ui.BotonOprimido;
            ...
            CargarBarraRoomDTO _CargarBarraRoomDTO = ui.ObtenerParametrosENtrada(NombrebotonOprimido);


            if (_CargarBarraRoomDTO != null)
            {
                ui.Hide();
                ...
                try
                { 
                    CargarBarraRoom.Cargar(_uiapp, _CargarBarraRoomDTO);
                }
