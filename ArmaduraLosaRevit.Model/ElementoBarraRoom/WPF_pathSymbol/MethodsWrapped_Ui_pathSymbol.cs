...
namespace ArmaduraLosaRevit.Model.ElementoBarraRoom.WPF_pathSymbol
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<Ui_pathSymbol>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, Ui_pathSymbol ui)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_Ui_pathSymbol.M1_DocumentEditPAth(ui, uiApp);
