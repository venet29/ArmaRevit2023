...
{
    public class GenerarGeometriaAhorro
    {
        private readonly UIApplication _uiapp;
        private readonly BarraRoom _barraRoom;
        private string _tipoBarra;
        private UbicacionLosa _UbicacionLosa;
        private View _view;
        private double espaciamiento;
        private double largoMinimo_foot;
        ...
        public GenerarGeometriaAhorro(UIApplication _uiapp, BarraRoom barraRoom)
        {
            this._uiapp = _uiapp;
            this._barraRoom = barraRoom;
            this._tipoBarra = _barraRoom.TipoBarraStr;
            this._UbicacionLosa = barraRoom.ubicacionEnlosa;
        ...
        public bool Ejecutar()
        {
            try
            {
                try
                {
                    ...
                    largoMinimo_foot = _GenerarGeometriaAhorroDTO._refereciaRoomDatos.largomin_1;
        ...
        private void GenerarPuntosCoordenadas()
        {
            ...
            largo_L3 = largoMinimo_foot * 0.15;
        }

        public RebarInferiorDTO ObtenerGEometria1()
        {
            if (_tipoBarra == "f3_incli")
            {
                _p1_1 = _p1;
                _p2_1 = _p2 + _dir_p2_p3 * 0 + _dir_p1_p2 * espaciamiento / 2;
                _p3_1 = _p3 + _dir_p2_p3 * largo_L3 + _dir_p1_p2 * espaciamiento / 2;
                _p4_1 = _p4 + _dir_p2_p3 * largo_L3;

            }
            else if (_tipoBarra == "f1_incliInf")
            {
                if (_UbicacionLosa == UbicacionLosa.Derecha || _UbicacionLosa == UbicacionLosa.Superior)
                {
                    _p1_1 = _p1 + _dir_p2_p3 * -largo_L3 + _dir_p1_p2 * espaciamiento / 2;
                    _p2_1 = _p2 + _dir_p2_p3 * -largo_L3 + _dir_p1_p2 * espaciamiento / 2;
                    _p3_1 = _p3 + _dir_p2_p3 * 0 + _dir_p1_p2 * espaciamiento / 2;
                    _p4_1 = _p4 + _dir_p2_p3 * 0 + _dir_p1_p2 * 0;
                }
                else if (_UbicacionLosa == UbicacionLosa.Inferior || _UbicacionLosa == UbicacionLosa.Izquierda)
                {
                    _p1_1 = _p1 + _dir_p2_p3 * 0 + _dir_p1_p2 * 0;
                    _p2_1 = _p2 + _dir_p2_p3 * 0 + _dir_p1_p2 * espaciamiento / 2;
                    _p3_1 = _p3 + _dir_p2_p3 * largo_L3 + _dir_p1_p2 * espaciamiento / 2;
                    _p4_1 = _p4 + _dir_p2_p3 * largo_L3 + _dir_p1_p2 * 0;
                }

        
            }
            ListaPtosPerimetroBarras1.Add(_p1_1);
        ...
        internal RebarInferiorDTO ObtenerGEometria2()
        {
            ...
            if (_tipoBarra == "f3_incli")
            {
                _p1_2 = _p1 - _dir_p2_p3 * largo_L3 - _dir_p1_p2 * espaciamiento / 2;
                _p2_2 = _p2 - _dir_p2_p3 * largo_L3 + _dir_p1_p2 * (espaciamiento + restoEntero / 2);
                _p3_2 = _p3 - _dir_p2_p3 * 0 + _dir_p1_p2 * (espaciamiento + restoEntero / 2);
                _p4_2 = _p4 - _dir_p2_p3 * 0 - _dir_p1_p2 * espaciamiento / 2;
            }
            else if (_tipoBarra == "f1_incliInf")
            {
                _p1_2 = _p1 - _dir_p2_p3 * 0 - _dir_p1_p2 * espaciamiento / 2;
                _p2_2 = _p2 - _dir_p2_p3 * 0 + _dir_p1_p2 * (espaciamiento + restoEntero / 2);
                _p3_2 = _p3 - _dir_p2_p3 * 0 + _dir_p1_p2 * (espaciamiento + restoEntero / 2);
                _p4_2 = _p4 - _dir_p2_p3 * 0 - _dir_p1_p2 * espaciamiento / 2;
            }
