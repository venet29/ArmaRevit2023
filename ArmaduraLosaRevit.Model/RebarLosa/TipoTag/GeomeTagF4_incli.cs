...
namespace ArmaduraLosaRevit.Model.RebarLosa.TipoTag
{
    ...
    public class GeomeTagF4_incli : GeomeTagBaseRebar, IGeometriaTag
    {
    ...
    //    private RebarInferiorDTO _rebarInferiorDTO1;
      ...
      //  private VectorDireccionLosaExternaInclinadaDTO _vectorDireccionLosaInicialExternaInclinadaDTO;
       // private VectorDireccionLosaExternaInclinadaDTO _vectorDireccionLosaFinalExternaInclinadaDTO;
        ...
        public GeomeTagF4_incli(Document doc, RebarInferiorDTO rebarInferiorDTO1) :
        ...
        {
            ConstNH.sbLog.AppendLine($"GeomeTagF3_inclixxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
            ...
            TagP0_C = AgregarTagRebarLista("CLosa", 18, -15 + (int)(5 * _deltaZ / _largoRecorridoDeltaZ), _ptoMouse, $"MRA Rebar_CLosa_" + escala);
        ...
        public void M5_DefinirRebarShapeAhorro(Action<GeomeTagF4_incli> rutina)
        {
            rutina(this);
        }
