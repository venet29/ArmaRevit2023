...

{
    ...
    public class f10 : ARebarLosa, IRebarLosa
    {
...
#pragma warning restore CS0108 // 'f4_incli._uiapp' hides inherited member 'ARebarLosa._uiapp'. Use the new keyword if hiding was intended.
        ...
        public f10(UIApplication uiapp, RebarInferiorDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
            this._uiapp = uiapp;
            //  this._uiapp = uiapp;
        ...
        private void M1_1_1_Configuracion()
        {
            ...
            XYZ ptoiniAux = ptoini.ObtenerCopia();
            ptoini = ptofin.ObtenerCopia();
            ptofin = ptoiniAux;
            ...
            DireccionEspesor = -planarface.FaceNormal * _RebarInferiorDTO.espesorBarraEnLOsa_sinRecub_FooT;
            ...
            // para f12
            //ladoAB = Line.CreateBound(ptoini, ptoini + DireccionEspesor);
            //ladoBC = Line.CreateBound(ptoini + DireccionEspesor, ptofin + DireccionEspesor);
            //ladoCD = Line.CreateBound(ptofin + DireccionEspesor, ptofin);
        ...
        private void M1_2_3_PAthSymbolFalso()
        {
            ...
            ladoBC_pathSym = Line.CreateBound(ptoini_PthSymb + dirBarraPerpen * _RebarInferiorDTO.espesorBarraEnLOsa_sinRecub_FooT, ptoini_PthSymb);
            ladoCD_pathSym = Line.CreateBound(ptoini_PthSymb, ptofin_PthSymb);
            ladoDE_pathSym = Line.CreateBound(ptofin_PthSymb + dirBarraPerpen * _RebarInferiorDTO.espesorBarraEnLOsa_sinRecub_FooT, ptofin_PthSymb);
