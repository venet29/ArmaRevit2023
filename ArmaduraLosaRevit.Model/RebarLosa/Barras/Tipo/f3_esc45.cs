...
{
    public class f3_esc45 : ARebarLosa, IRebarLosa
    {
...
#pragma warning disable CS0108 // 'f3_esc45._largoPataInclinada' hides inherited member 'ARebarLosa._largoPataInclinada'. Use the new keyword if hiding was intended.
        private double _largoPataInclinada;
#pragma warning restore CS0108 // 'f3_esc45._largoPataInclinada' hides inherited member 'ARebarLosa._largoPataInclinada'. Use the new keyword if hiding was intended.
        private double _espesorSinRecubEscalera;
        private double _pataEscalera;

        public f3_esc45(UIApplication uiapp, RebarInferiorDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
            ...
            //definir para parametros compartidos
            _Prefijo_F = "F=";
        ...
        private void M1_2_3_PAthSymbolFalsoIzqInfer()
        {
            ...
            XYZ PE = Util.ExtenderPuntoRespectoOtroPtosConAngulo(ptofin_PthSymb, _RebarInferiorDTO.anguloBarraRad + _RebarInferiorDTO.anguloTramoRad, _RebarInferiorDTO.LargoPata);
            PE = PE.AsignarZ(zRefencia);
