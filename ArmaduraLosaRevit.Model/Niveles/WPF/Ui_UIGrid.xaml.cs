...
namespace ArmaduraLosaRevit.Model.Niveles.WPF
{
    ...
    /// </summary>
    public partial class Ui_Nivel : Window, INotifyPropertyChanged
    {
        ...
        public Ui_Nivel(UIApplication uiApp, EventHandlerWithStringArg evExternalMethodStringArg,
        ...
        private void BExternalMethod1_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (BotonOprimido == "btnAceptar_e" || BotonOprimido == "btnMultiple_e" || BotonOprimido == "btnAceptarBorrar1_e" || BotonOprimido == "btnBorrarMultiple_e")
            {
