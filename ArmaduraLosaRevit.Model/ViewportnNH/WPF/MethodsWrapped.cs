...
namespace ArmaduraLosaRevit.Model.ViewportnNH.WPF
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<UI_ViewPOrtNH>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, UI_ViewPOrtNH ui)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_ViewPortNH.M1_Ejecutar(ui, uiApp);
