...
{
    public class LetraCambiarf18 : LetraCambiar_base, ILetraCambiar
    {
 
        public LetraCambiarf18(Document doc, PathReinforcement pathReinforcement, string _TipoBarra) : base(doc, pathReinforcement, _TipoBarra)
        {
            Isok = true;
        }
            ...
            try
            {
                ...
                if (aux_espaciamiento != null)
                {
                    ...
                    new LetraCambiarDTO()
                    {
                        ...
                        valor = largoAltternativa + valorA
                    });
                }
            }
            catch (Exception ex)
