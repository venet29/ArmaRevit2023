...
{
    public class LetraCambiarf16 : LetraCambiar_base, ILetraCambiar
    {

        public ParametroLetra letraCambiar;
        public LetraCambiarf16(Document doc, PathReinforcement pathReinforcement, string _TipoBarra, ParametroLetra letraCambiar):base(doc,pathReinforcement, _TipoBarra)
        {
            this.letraCambiar = letraCambiar;
            Isok = true;
        }
        public LetraCambiarf16(Document doc, PathReinforcement pathReinforcement, string _TipoBarra) : base(doc, pathReinforcement, _TipoBarra)
        {
            Isok = true;
        }
