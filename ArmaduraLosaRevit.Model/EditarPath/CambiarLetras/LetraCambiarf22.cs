...
{
    public class LetraCambiarf22 : LetraCambiar_base, ILetraCambiar
    {

        public ParametroLetra letraCambiar;
        public LetraCambiarf22(Document doc, PathReinforcement pathReinforcement, string _TipoBarra, ParametroLetra letraCambiar):base(doc,pathReinforcement, _TipoBarra)
        {

            Isok = true;
        }
        public LetraCambiarf22(Document doc, PathReinforcement pathReinforcement, string _TipoBarra) : base(doc, pathReinforcement, _TipoBarra)
        {
            Isok = true;
        }
            ...
            try
            {
                ...
                if (aux_espaciamiento != null)
                {
                    ...
                    ListaLetraCambiarDTO.Add(
                        new LetraCambiarDTO()
                        {
                            letraCambiar = ParametroLetra.A_,
                            valor = largoCentral
                        });
