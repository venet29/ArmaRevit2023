...
{
    public class EditBarraF16 : EditarPathRein_Base
    {
        public EditBarraF16(UIApplication uiapp, SeleccionarPathReinfomentConPto _seleccionarPathReinfomentConPto) : base(uiapp, _seleccionarPathReinfomentConPto)
        {
