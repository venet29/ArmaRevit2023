...
{
    public class EditBarraF16B : EditarPathRein_Base
    {
        public EditBarraF16B(UIApplication uiapp, SeleccionarPathReinfomentConPto _seleccionarPathReinfomentConPto) : base(uiapp, _seleccionarPathReinfomentConPto)
        {
