...
{
    public class EditBarraF20A : EditarPathRein_Base
    {
        public EditBarraF20A(UIApplication uiapp, SeleccionarPathReinfomentConPto _seleccionarPathReinfomentConPto) : base(uiapp, _seleccionarPathReinfomentConPto)
        {
