...
{
    public class EditBarraF21B : EditarPathRein_Base
    {
        public EditBarraF21B(UIApplication uiapp, SeleccionarPathReinfomentConPto _seleccionarPathReinfomentConPto) : base(uiapp, _seleccionarPathReinfomentConPto)
        {
