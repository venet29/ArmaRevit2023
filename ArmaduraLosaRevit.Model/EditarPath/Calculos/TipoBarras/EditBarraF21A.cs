...
{
    public class EditBarraF21A : EditarPathRein_Base
    {
        public EditBarraF21A(UIApplication uiapp, SeleccionarPathReinfomentConPto _seleccionarPathReinfomentConPto) : base(uiapp, _seleccionarPathReinfomentConPto)
        {
