...
{
    public class EditBarraF20B : EditarPathRein_Base
    {
        public EditBarraF20B(UIApplication uiapp, SeleccionarPathReinfomentConPto _seleccionarPathReinfomentConPto) : base(uiapp, _seleccionarPathReinfomentConPto)
        {
