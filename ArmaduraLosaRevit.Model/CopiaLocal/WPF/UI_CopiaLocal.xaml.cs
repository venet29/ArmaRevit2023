...
namespace ArmaduraLosaRevit.Model.CopiaLocal.WPF
{
    ...
    /// </summary>
    public partial class UI_CopiaLocal : Window, INotifyPropertyChanged
    {

        public string BotonOprimido { get; set; }
        public string EstadoCambio { get; private set; }
        ...
        public UI_CopiaLocal(UIApplication uiApp, EventHandlerWithStringArg evExternalMethodStringArg,
