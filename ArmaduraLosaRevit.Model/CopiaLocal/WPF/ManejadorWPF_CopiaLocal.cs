...
namespace ArmaduraLosaRevit.Model.CopiaLocal.WPF
{
    ...
    public class ManejadorWPF_CopiaLocal 
    {


        // ModelessForm instance
        private UI_CopiaLocal _mMyForm;
        private UIApplication _UIapp;

        public ManejadorWPF_CopiaLocal(UIApplication _uiapp)
        {
            _UIapp = _uiapp;
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new UI_CopiaLocal(_UIapp, evStr, evWpf);
