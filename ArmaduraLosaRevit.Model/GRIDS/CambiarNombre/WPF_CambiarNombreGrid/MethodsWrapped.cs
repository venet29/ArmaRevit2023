...
namespace ArmaduraLosaRevit.Model.GRIDS.WPF_CambiarNombreGrid
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<UI_CambiarNombreGrid>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, UI_CambiarNombreGrid ui)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_CambiarNombreGrid.M1_Ejecutar(ui, uiApp);
