...
namespace ArmaduraLosaRevit.Model.Armadura
{
    ...
    public class AreaReinData
    {
        ...
        /// </summary>
        [CategoryAttribute("Construction"), DefaultValueAttribute(LayoutRules.Maximum_Spacing)]
        ...
        public virtual void FillIn(AreaReinforcement areaRein)
        {
            ...
            bool flag = ParameterUtil.SetParaInt(areaRein, BuiltInParameter.REBAR_SYSTEM_LAYOUT_RULE, temp);

            if (!flag)
            {
                Parameter paraLayout = ParameterUtil.FindParaByName(areaRein.Parameters, "Layout Rule");
                if (null != paraLayout)
                {
                    paraLayout.Set(temp);
                }
    ...
    public class AreaReinDataOnFloor : AreaReinData
    {
        ...
        public override void FillIn(AreaReinforcement areaRein)
        {
            ...
            ParameterUtil.SetParaInt(areaRein, BuiltInParameter.REBAR_SYSTEM_ACTIVE_BOTTOM_DIR_1, Convert.ToInt32(m_bottomMajorDirection));
            ParameterUtil.SetParaInt(areaRein, BuiltInParameter.REBAR_SYSTEM_ACTIVE_BOTTOM_DIR_2, Convert.ToInt32(m_bottomMinorDirection));
            ParameterUtil.SetParaInt(areaRein, BuiltInParameter.REBAR_SYSTEM_ACTIVE_TOP_DIR_1, Convert.ToInt32(m_topMajorDirection));
            ParameterUtil.SetParaInt(areaRein, BuiltInParameter.REBAR_SYSTEM_ACTIVE_TOP_DIR_2, Convert.ToInt32(m_topMinorDirection));
        }
    }
}
