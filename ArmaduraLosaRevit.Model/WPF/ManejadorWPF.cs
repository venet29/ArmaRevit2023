...
namespace ArmaduraLosaRevit.Model.WPF
{
    ...
    {
        private  SeleccionarPathReinfomentConPto seleccionarPathReinfomentConPto;

        // ModelessForm instance
        private Ui _mMyForm;
        private UIApplication _UIapp;

        public ManejadorWPF(ExternalCommandData commandData, SeleccionarPathReinfomentConPto seleccionarPathReinfomentConPto)
        {
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new Ui(uiapp, evStr, evWpf, seleccionarPathReinfomentConPto);
