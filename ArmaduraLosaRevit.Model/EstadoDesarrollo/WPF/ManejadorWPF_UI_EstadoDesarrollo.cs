...
namespace ArmaduraLosaRevit.Model.EstadoDesarrollo.WPF
{
    ...
    public class ManejadorWPF_UI_EstadoDesarrollo
    {


        // ModelessForm instance
        private UI_EstadoDesarrollo _mMyForm;
        private UIApplication _UIapp;

        public ManejadorWPF_UI_EstadoDesarrollo(UIApplication _uiapp)
        {
            _UIapp = _uiapp;
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new UI_EstadoDesarrollo(_UIapp, evStr, evWpf);
