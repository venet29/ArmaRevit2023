...
namespace ArmaduraLosaRevit.Model.TablasSchedule.Wpf
{
    /// <summary>
    /// Interaction logic for UI.xaml
    /// </summary>
    public partial class Ui_Schedule : Window, INotifyPropertyChanged
    {
        ...
        public Ui_Schedule(UIApplication uiApp   )
        {
            _uiApp = uiApp;
