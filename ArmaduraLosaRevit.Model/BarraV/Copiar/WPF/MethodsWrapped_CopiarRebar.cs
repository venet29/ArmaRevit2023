...
namespace ArmaduraLosaRevit.Model.BarraV.Copiar.WPF
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<UI_CopiarRebarElev>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, UI_CopiarRebarElev ui)
        {
            // SETUP
            ...
            Methods_CopiarRebar.M1_Cub(ui, uiApp);
