...
{
    public class IniciarSinTraslapoV_Horq : IIniciarConXTraslapo
    {
      ...
      //  private readonly MuroSeleccionadoDTO _muroSeleccionadoDTO;
        ...
        public IniciarSinTraslapoV_Horq(SelecionarPtoSup selecionarPtoSup, ConfiguracionIniciaWPFlBarraVerticalDTO confiEnfierradoDTO)
        {
        ...
        private void M1_GenerarBArraInicial()
        {
            try
            {
                TipoPataBarra tipobarraInicial = _confiEnfierradoDTO.inicial_tipoBarraV;
