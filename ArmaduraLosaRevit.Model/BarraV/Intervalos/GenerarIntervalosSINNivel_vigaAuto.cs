...
namespace ArmaduraLosaRevit.Model.BarraV.Intervalos
{
    ...
    public class GenerarIntervalosSINNivel_vigaAuto : IGenerarIntervalosH
    {
        ...
        public GenerarIntervalosSINNivel_vigaAuto(UIApplication _uiapp, ConfiguracionInicialBarraHorizontalDTO confiEnfierradoDTO,
        ...
        protected void M1_1_GEnerarListaIntervaloBarrasDTO()
        {
            ...
            foreach (CoordenadasBarra item in _iniciarSinTraslapo.ListaCoordenadasBarra)
            {
                ...
                interBArraDto.ptoini = interBArraDto.ptoini.AsignarZ(item.ptoIni_foot.Z);
                interBArraDto.ptoPosicionTAg = interBArraDto.ptoPosicionTAg.AsignarZ((item.ptoIni_foot.Z + item.ptoFin_foot.Z) / 2);
                interBArraDto.ptofinal = interBArraDto.ptofinal.AsignarZ(item.ptoFin_foot.Z);
                ...
                interBArraDto.IsIsDirectriz = (_confiEnfierradoDTO.incial_IsDirectriz ? true : false);
                interBArraDto.BuscarPatasAmbosLadosHorizontal(_uiapp, _confiEnfierradoDTO._empotramientoPatasDTO);
                interBArraDto._parametrosInternoRebarDTO._NUmeroLinea_paraTagRefuerzo = _confiEnfierradoDTO._NUmeroLinea_paraTagRefuerzo;
        ...
        public virtual List<IbarraBase> M2_GenerarListaBarraHorizontal()
        {
            ...
            try
            {
                ...
                {
                    IGeometriaTag _newGeometriaTag = default;
                    if (itemIntervaloBarrasDTO.IsIsDirectriz)
                    {
                        _newGeometriaTag = FactoryGeomTagRebarH.CrearGeometriaTagH_RefuerzoVIga(_uiapp,
                    ...
                    {
                        _newGeometriaTag = FactoryGeomTagRebarH.CrearGeometriaTagH(_uiapp,
                                                                       itemIntervaloBarrasDTO.tipobarraV,
                                                                       itemIntervaloBarrasDTO.ptoini,
                                                                       itemIntervaloBarrasDTO.ptofinal,
