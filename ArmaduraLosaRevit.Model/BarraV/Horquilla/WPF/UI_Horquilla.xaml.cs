...
namespace ArmaduraLosaRevit.Model.BarraV.Horquilla.WPF
{
    ...
    /// </summary>
    public partial class UI_Horquilla : Window, INotifyPropertyChanged
    {
        ...
        public UI_Horquilla(UIApplication uiApp, EventHandlerWithStringArg evExternalMethodStringArg,
        ...
        public ConfiguracionIniciaWPFlBarraVerticalDTO ObtenerConfiguracionInicialBarraVerticalVDTO()
        {
            ...
            {
                inicial_diametroMM = Util.ConvertirStringInInteger(dtDiametroHorq.Text),
                Inicial_Cantidadbarra = dtCantidadHorq.Text,
                Document_ = _doc,
                //cbx_tipopata.Text
                inicial_tipoBarraV = TipoPataBarra.BarraVHorquilla,// Enumeraciones.TipoBarraV.BarraVSinPatas,
                inicial_IsDirectriz = true,
                Inicial_espacienmietoCm_EntreLineasBarras = "15",
                TipoSeleccionMousePtoInferior = TipoSeleccionMouse.mouse,
                TipoSeleccionMousePtoSuperior = TipoSeleccionMouse.mouse,
                IsDibujarTag = true,
                IsInvertirPosicionTag =false,
                TipoBarraRebar_ = TipoBarraVertical.Cabeza_Horquilla,
                BarraTipo = TipoRebar.ELEV_BA_HORQ,
                TipoSelecion = TipoSeleccion.ConElemento
            };
            return confiEnfierradoDTO;
        }

        internal ConfiguracionInicialBarraVerticalHorqDTO ObtenerConfiguracionInicialBarraVerticalHorqDTO()
        {
            return new ConfiguracionInicialBarraVerticalHorqDTO() {
                inicial_diametroHorqMM = Util.ConvertirStringInInteger(dtDiametro.Text),
                inicial_NumeroHorq = "2",
                Document_ = _doc,
                inicial_diametroMM = Util.ConvertirStringInInteger(dtDiametro.Text),
                inicial_Numero="2"               
            };
        }
