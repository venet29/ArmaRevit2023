...
namespace ArmaduraLosaRevit.Model.BarraV.Horquilla.WPF
{
    ...
    public class ManejadorWPF_Horquilla 
    {


        // ModelessForm instance
        private UI_Horquilla _mMyForm;
        private UIApplication _UIapp;

        public ManejadorWPF_Horquilla(UIApplication _uiapp)
        {
            _UIapp = _uiapp;
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new UI_Horquilla(_UIapp, evStr, evWpf);
