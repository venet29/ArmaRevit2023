...
{
    public class GruposListasTraslapoIguales_V
    {
        private UIApplication uiapp;
        private Document _doc;
        private List<RebarDesglose_GrupoBarras_V> GruposRebarMismaLinea;

        public List<RebarDesglose_GrupoBarras_V> soloListaPrincipales { get; set; }
        public GruposListasTraslapoIguales_V(UIApplication uiapp, List<RebarDesglose_GrupoBarras_V> lista_RebarDesglose)
        {
            this.uiapp = uiapp;
        ...
        public bool ObtenerGruposTraslaposIguales(Config_EspecialElev _Config_EspecialElv)
        {
            try
            {
                ...
                {
                    List<RebarDesglose_GrupoBarras_V> _ListRebarDesglose_GrupoBarras = itemGrup.ToList();
                    ...
                    for (int j = 0; j < _ListRebarDesglose_GrupoBarras.Count; j++)
                    {
                        ...
                        List<RebarDesglose_GrupoBarras_V> _ListRebarDesglose_GrupoBarrasRepetidas = new List<RebarDesglose_GrupoBarras_V>();
        ...
        private static void AgregarPAra(ParametroShareNhDTO _Paratipobarra, char letar, string idLetra, RebarDesglose_Barras_V SUBitem)
        {
        ...
        private bool VerificarGrupoBArrasRepetidas(RebarDesglose_GrupoBarras_V GrupoBarrasPrincipa, RebarDesglose_GrupoBarras_V GrupoBarraRepetido)
        {
            try
            {
                ...
                {
                    RebarDesglose_Barras_V _barraPrincipal = GrupoBarrasPrincipa._GrupoRebarDesglose[i];
                    RebarDesglose_Barras_V _barraRepetida = GrupoBarraRepetido._GrupoRebarDesglose[i];
