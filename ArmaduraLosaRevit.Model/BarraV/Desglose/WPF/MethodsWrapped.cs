...
namespace ArmaduraLosaRevit.Model.BarraV.Desglose.WPF
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<UI_desglose>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, UI_desglose ui)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods.M1_Desglose(ui, uiApp);
