...
{
    public class BarraVPataInicial : ABarrasElevV_SinTrans, IbarraBase
    {
        public bool IsOk { get; set; }

        public BarraVPataInicial(UIApplication uiapp, IntervaloBarrasDTO interBArraDto, IGeometriaTag _newGeometriaTag) : base(uiapp, interBArraDto, _newGeometriaTag)
        {
            IsOk = true;
        }
        ...
        public override void M0_CalcularCurva()
        {
            ...
            //a
            Curve ladoPataBajo = Line.CreateBound(_interBArraDto.ptoini + _interBArraDto.DireccionPataEnFierrado * _SRBE.largoPata, _interBArraDto.ptoini);
