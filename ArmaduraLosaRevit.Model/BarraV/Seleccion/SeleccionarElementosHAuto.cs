...
namespace ArmaduraLosaRevit.Model.BarraV.Seleccion
{
    ...
    public class SeleccionarElementosHAuto : SeleccionarElementosH
    {

        private View3D _view3D_BUSCAR;

#pragma warning disable CS0414 // The field 'SeleccionarElementosHAuto._ubicacionBarras' is assigned but its value is never used
        private TipoCaraObjeto _ubicacionBarras;
#pragma warning restore CS0414 // The field 'SeleccionarElementosHAuto._ubicacionBarras' is assigned but its value is never used
        ...
        public SeleccionarElementosHAuto(UIApplication _uiapp, ConfiguracionInicialBarraHorizontalDTO _configuracionInicialBarraHorizontalDTO, DireccionRecorrido _DireccionRecorrido)
        ...
        public bool M1_6_ObtenerListaIntervalos(TipoCaraObjeto _ubicacionBarras)
        {
            ...
            try
            {
                if (TipoCaraObjeto.Superior == _ubicacionBarras)
                {
                    ...
                    DireccionBordeElemeto = (CoordenadasElementoDTO._ptobarra2Sup_conrecub - CoordenadasElementoDTO._ptobarra1Sup_conrecub).Normalize();
                    ...
                    _listaptoTramo.Add(CoordenadasElementoDTO._ptobarra1Sup_conrecub);
                    _listaptoTramo.Add(CoordenadasElementoDTO._ptobarra2Sup_conrecub);
                    _listaptoTramoSup.AddRange(_listaptoTramo);
                }
                else
                {
                    DireccionBordeElemeto = (CoordenadasElementoDTO._ptobarra2Inf_conrecub - CoordenadasElementoDTO._ptobarra1Inf_conrecub).Normalize();
                    PtoInicioBaseBordeViga_ProyectadoCaraMuroHost =
                    ...
                    _listaptoTramo.Add(CoordenadasElementoDTO._ptobarra1Inf_conrecub);
                    _listaptoTramo.Add(CoordenadasElementoDTO._ptobarra2Inf_conrecub);
                    _listaptoTramoSup.AddRange(_listaptoTramo);
                }
        ...
        public bool M1_6_ObtenerListaIntervalos_Conviga(BarraFlexion _barraFlexion)
        {
            ...
            try
            {
                if (TipoCaraObjeto.Superior == _barraFlexion.Ubicacion)
                {
                    ...
                    DireccionBordeElemeto = (CoordenadasElementoDTO._ptobarra2Sup_conrecub - CoordenadasElementoDTO._ptobarra1Sup_conrecub).Normalize();
                    PtoInicioBaseBordeViga_ProyectadoCaraMuroHost =
                        (CoordenadasElementoDTO._ptobarra2Sup_conrecub + CoordenadasElementoDTO._ptobarra1Sup_conrecub) / 2 + (new XYZ(0, 0, 1) * (ConstNH.RECUBRIMIENTO_ESTRIBO_FOOT - Util.CmToFoot(8)*(_barraFlexion.Linea-1)));
                ...
                else
                {
                    DireccionBordeElemeto = (CoordenadasElementoDTO._ptobarra2Inf_conrecub - CoordenadasElementoDTO._ptobarra1Inf_conrecub).Normalize();
                    PtoInicioBaseBordeViga_ProyectadoCaraMuroHost =
                        (CoordenadasElementoDTO._ptobarra2Inf_conrecub + CoordenadasElementoDTO._ptobarra1Inf_conrecub) / 2 - (new XYZ(0, 0, 1) * (ConstNH.RECUBRIMIENTO_ESTRIBO_FOOT - Util.CmToFoot(8) * (_barraFlexion.Linea - 1)));
