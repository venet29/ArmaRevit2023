...
{
    public class GeomeTagPataInicialV : GeomeTagBaseV, IGeometriaTag
    {
   

        public GeomeTagPataInicialV(Document doc,  XYZ ptoIni, XYZ ptoFin, XYZ posiciontag) :
        ...
        public void M5_DefinirRebarShapeAhorro(Action<GeomeTagPataInicialV> rutina)
        {
            rutina(this);
        }
