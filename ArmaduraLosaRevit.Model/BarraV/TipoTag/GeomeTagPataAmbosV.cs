...
{
    public class GeomeTagPataAmbosV : GeomeTagBaseV, IGeometriaTag
    {
   

        public GeomeTagPataAmbosV(Document doc,  XYZ ptoIni, XYZ ptoFin, XYZ posiciontag) :
            base(doc,  ptoIni, ptoFin, posiciontag)
        { }

        public GeomeTagPataAmbosV() { }
        ...
        public void M5_DefinirRebarShapeAhorro(Action<GeomeTagPataAmbosV> rutina)
        {
            rutina(this);
        }
