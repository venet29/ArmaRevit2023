...
{
    public class GeomeTagPataFinalV : GeomeTagBaseV, IGeometriaTag
    {
   

        public GeomeTagPataFinalV(Document doc,  XYZ ptoIni, XYZ ptoFin, XYZ posiciontag) :
            base(doc,  ptoIni, ptoFin, posiciontag)
        { }

        public GeomeTagPataFinalV() { }


        public override void M3_DefinirRebarShape()=>  AsignarPArametros(this); 
    
        public bool M4_IsFAmiliaValida() => true;
        public void M5_DefinirRebarShapeAhorro(Action<GeomeTagPataFinalV> rutina)
        {
            rutina(this);
        }
