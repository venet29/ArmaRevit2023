...
namespace ArmaduraLosaRevit.Model.BarraV.Automatico.WPF
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<UI_VariasElevAuto>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, UI_VariasElevAuto ui)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_VariasElevAuto.M1_Cub(ui, uiApp);
