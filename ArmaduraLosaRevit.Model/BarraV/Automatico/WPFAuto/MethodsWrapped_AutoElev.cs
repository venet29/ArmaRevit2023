...
namespace ArmaduraLosaRevit.Model.BarraV.Automatico.WPFAuto
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<Ui_AutoElev>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, Ui_AutoElev ui_BarraV)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_AutoElev.M1_EjecutarRutinas(ui_BarraV, uiApp);
