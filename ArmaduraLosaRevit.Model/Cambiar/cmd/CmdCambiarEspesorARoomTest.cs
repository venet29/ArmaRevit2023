...
namespace ArmaduraLosaRevit.Model.Cambiar.CambiarEspesor.cmd
{
    ...
    public class CmdCambiarEspesorARoomTest : IExternalCommand
    {
        ...
        public Autodesk.Revit.UI.Result Execute(ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            ...
            iManejadorRoomCambioEspesor.M6_ObtenerRoomDeLosa(floor);
            int resultCAntidadRoomCambiados = iManejadorRoomCambioEspesor.M7_CAmbiarPArametroEspesorDeRoom(15);
            Debug.Assert(resultCAntidadRoomCambiados == 16);
