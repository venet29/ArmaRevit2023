...
{
    public class MallaVPataFinal : ABarrasElevV_SinTrans, IbarraBase
    {
        public bool IsOk { get; set; }
        public MallaVPataFinal(UIApplication uiapp, IntervaloBarrasDTO interBArraDto, IGeometriaTag _newGeometriaTag) : base(uiapp, interBArraDto, _newGeometriaTag)
        {
            IsOk = true;
        }
