...
{
    public class MallaVSinPatas : ABarrasElevV_SinTrans, IbarraBase
    {
        public bool IsOk { get; set; }
        public MallaVSinPatas(UIApplication uiapp, IntervaloBarrasDTO interBArraDto, IGeometriaTag _newGeometriaTag) : base(uiapp, interBArraDto, _newGeometriaTag)
        {
            IsOk = true;
        }
