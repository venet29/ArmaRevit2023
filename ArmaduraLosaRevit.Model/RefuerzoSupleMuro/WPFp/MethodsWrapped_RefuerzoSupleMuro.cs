...
namespace ArmaduraLosaRevit.Model.RefuerzoSupleMuro.WPFp
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<Ui_RefuerzoSupleMuro>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, Ui_RefuerzoSupleMuro ui_pelotaLosa)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_RefuerzoSupleMuro.M1_EjecutarRutinas(ui_pelotaLosa, uiApp);
