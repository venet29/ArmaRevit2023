...
namespace ArmaduraLosaRevit.Model.Visibilidad.BlancoNegro.WPF
{
    ...
    public class ManejadorWPF_FormatoEntrega
    {


        // ModelessForm instance
        private UI_FormatoEntrega _mMyForm;
        private UIApplication _uiapp;

        public ManejadorWPF_FormatoEntrega(UIApplication _uiapp)
        {
            this._uiapp = _uiapp;
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new UI_FormatoEntrega(_uiapp, evStr, evWpf);
