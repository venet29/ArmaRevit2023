...
namespace ArmaduraLosaRevit.Model.Elementos_viga
{
    ...
    public class ProfileBeam : Profile
    {
        ...
        public FamilyInstance m_data { get; set; }
        ...
        public ProfileBeam(FamilyInstance beam, ExternalCommandData commandData) : base(commandData.Application)
        {
        ...
        public ProfileBeam(FamilyInstance beam, ExternalCommandData commandData, Level level) : base(commandData.Application, level)
        {
            ListaPtoEdgeFaceUP = new List<List<XYZ>>();
            m_data = beam;
            List<List<Edge>> faces = GetFaces(m_data);
        ...
        /// <summary>
        /// se implemento en 'Profile'
        /// trata de obtener la cara superior usando arragles de edge
        /// </summary>
        /// <param name="faces"> lista de lista de edge de cada cara </param>
        /// <returns> la cara con normal zAxis  , pero no esta funcionado el vector normal    -->     Vector4 normal = GetFaceNormal(face);  </returns>
        //public List<List<XYZ>> GetNeedPointsNormalUpFace(List<List<Edge>> faces)
        //{
        ...
        //            {
        //                // este vector normal no esta funcionando
