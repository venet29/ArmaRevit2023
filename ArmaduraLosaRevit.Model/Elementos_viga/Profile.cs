...
namespace ArmaduraLosaRevit.Model.Elementos_viga
{
    ...
    public abstract class Profile
    {
        ...
        public List<List<XYZ>> ListaPtoFaceUP { get; set; }
        public List<List<XYZ>> ListaPtoFaceDown { get; set; }
        public List<XYZ> ListaPtoFaceNivelLosa { get; set; }
        public Level NivelLosa { get; set; }
       ...
       // protected Autodesk.Revit.UI.ExternalCommandData m_commandData;
        ...
        protected Profile(UIApplication uiapp)
        {
            //m_commandData = commandData;
            _uiapp = uiapp;
            m_appCreator = _uiapp.Application.Create;
            m_docCreator = _uiapp.ActiveUIDocument.Document.Create;

            ListaPtoFaceUP = new List<List<XYZ>>();
            ListaPtoFaceDown = new List<List<XYZ>>();

        }
        protected Profile(UIApplication uiapp, Level nivelLevel)
        {
            _uiapp = uiapp;
            m_appCreator = _uiapp.Application.Create;
            m_docCreator = _uiapp.ActiveUIDocument.Document.Create;
            ...
            ListaPtoFaceUP = new List<List<XYZ>>();
            ListaPtoFaceDown = new List<List<XYZ>>();
            ListaPtoFaceNivelLosa = new List<XYZ>();
            NivelLosa = nivelLevel;
        }
