        ...
        public Autodesk.Revit.UI.Result Execute(ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            ...
            try
            {
                ...
                if (administrador_ReferenciaRoom.SeleccionadosMultiplesPathReinConRectaguloYFiltros())
                {
                    ...
                    IList<ElementId> lista = administrador_ReferenciaRoom.ObtenerListaIDSeleccionados();
                    if (lista.Count > 0)
                    {
                        commandData.Application.ActiveUIDocument.Selection.SetElementIds(lista);
                        commandData.Application.ActiveUIDocument.ShowElements(lista);
                    }
                }
