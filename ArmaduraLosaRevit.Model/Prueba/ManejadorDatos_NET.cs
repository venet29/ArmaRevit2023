...
namespace ArmaduraLosaRevit.Model.Prueba
{
    ...
    sealed public class ManejadorDatos_NET
...
//#endif
    ...
    public class Conterrors_NET
    {
        public errors[] errors { get; set; }

    }

    public class errors_NET
    {
    ...
    public class ResultDTO_NET
    {
        public string msg { get; set; }
        public bool Isok { get; set; }
        public ResultDTO_NET()
        {
    ...
    public class ListaBitacoraDTO_NET
    {
        public string msg { get; set; }
    ...
    public class ListaInscripcionDTO_NET
    {
        public string msg { get; set; }
    ...
    public class InscripcionDTO_NET
    {
    ...
    public class InfoSystema_validar_NET
    {
        #region 0)propieades
        ...
        #region 1)Contructor
        public InfoSystema_validar_NET() { }
        public InfoSystema_validar_NET(string ruta, string caso)
        {
            this.ruta = ruta;
            this.caso = caso;
