...
namespace ArmaduraLosaRevit.Model.Fund.CMD
{
    ...
    public class cmd_FundManejadorManual : IExternalCommand
    {
        ...
        public Autodesk.Revit.UI.Result Execute(ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            ...
            FundManejador _fundManejador = new FundManejador(commandData.Application);
    ...
    [Autodesk.Revit.Attributes.Transaction(Autodesk.Revit.Attributes.TransactionMode.Manual)]
    [Autodesk.Revit.Attributes.Regeneration(Autodesk.Revit.Attributes.RegenerationOption.Manual)]
    public class cmd_FundManejadorAutomatico : IExternalCommand
    {
        ...
        public Autodesk.Revit.UI.Result Execute(ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            ...
            CasosFundDTO _casosFundDTO = new CasosFundDTO();

            _casosFundDTO.SuperiorHorizontal = true;
            _casosFundDTO.SuperiorVertical = true;
            _casosFundDTO.InferiorHorizontal = true;
            _casosFundDTO.InferiorVertical = true;

            FundManejador _fundManejador = new FundManejador(commandData.Application);
            _fundManejador.executeAutomatico(_datosNuevaBarraDTOIniciales, _casosFundDTO);
