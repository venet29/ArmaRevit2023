...
namespace ArmaduraLosaRevit.Model.Fund.WPFfund
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<Ui_barraFund>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, Ui_barraFund ui_barraFund)
        {
            // SETUP
     
           // UIDocument uiDoc = uiApp.ActiveUIDocument;
           // Document doc = uiDoc.Document;
            Methods_fund.M1_EjecutarRutinas(ui_barraFund, uiApp);
