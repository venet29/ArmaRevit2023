...
{
    public class GeomeTagFundRebarAmbasPata_auto : GeomeTagBaseH, IGeometriaTag
    {
        private readonly PathReinfSeleccionDTO _pathReinfSeleccionDTO;
        private List<XYZ> _listaPtosPerimetroBarras;

        public GeomeTagFundRebarAmbasPata_auto(UIApplication uiapp, XYZ ptoMOuse, PathReinfSeleccionDTO _PathReinfSeleccionDTO) :
        ...
        public void AsignarPArametros(GeomeTagFundRebarAmbasPata_auto _geomeTagBase)
        {
