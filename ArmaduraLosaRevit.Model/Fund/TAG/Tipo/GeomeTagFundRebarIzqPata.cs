...
{
    public class GeomeTagFundRebarIzqPata : GeomeTagFundRebarAmbasPata_auto
    {
  
        public GeomeTagFundRebarIzqPata(UIApplication uiapp, XYZ ptoMOuse, PathReinfSeleccionDTO _PathReinfSeleccionDTO) :
