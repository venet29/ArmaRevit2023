...

{
    ...
    public class f10A_fund : ARebarLosa, IRebarLosa
    {
        ...
        public f10A_fund(UIApplication uiapp, RebarInferiorDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
            this._uiapp = uiapp;
            //  this._uiapp = uiapp;
            ...
            LArgoPataHOok_foot = Util.CmToFoot(_RebarInferiorDTO.DatosNuevaBarraDTO.LargoPAtaIzqHook_cm - _RebarInferiorDTO.diametroMM / 20.0D);
