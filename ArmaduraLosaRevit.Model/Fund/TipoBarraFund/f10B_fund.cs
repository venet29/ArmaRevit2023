...

{
    ...
    public class f10B_fund : ARebarLosa, IRebarLosa
    {
        ...
        public f10B_fund(UIApplication uiapp, RebarInferiorDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
            this._uiapp = uiapp;
            //  this._uiapp = uiapp;
            ...
            LArgoPataHOok_foot = Util.CmToFoot(_RebarInferiorDTO.DatosNuevaBarraDTO.LargoPAtaDereHook_cm - _RebarInferiorDTO.diametroMM / 20.0D);
        ...
        private void M1_2_3_PAthSymbolFalso()
        {
           ...
           // ladoBC_pathSym = Line.CreateBound(ptoini_PthSymb + dirBarraPerpen * LArgoPataHOok_foot, ptoini_PthSymb);
            ladoCD_pathSym = Line.CreateBound(ptoini_PthSymb, ptofin_PthSymb);
            ladoDE_pathSym = Line.CreateBound(ptofin_PthSymb + dirBarraPerpen * LArgoPataHOok_foot, ptofin_PthSymb);
