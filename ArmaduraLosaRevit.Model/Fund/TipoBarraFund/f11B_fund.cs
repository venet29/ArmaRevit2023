...

{
    ...
    public class f11B_fund : ARebarLosa, IRebarLosa
    {
        ...
        public f11B_fund(UIApplication uiapp, RebarInferiorDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
            this._uiapp = uiapp;
            //  this._uiapp = uiapp;
        ...
        private void M1_1_1_ConfiguracionIzq()
        {
            ...
            ladoBC = Line.CreateBound(ptofin, ptofin + DireccionEspesor);//ladoCD
