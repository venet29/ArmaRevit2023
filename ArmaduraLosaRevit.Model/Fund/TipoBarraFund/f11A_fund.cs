...

{
    ...
    public class f11A_fund : ARebarLosa, IRebarLosa
    {
        ...
        public f11A_fund(UIApplication uiapp, RebarInferiorDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
            this._uiapp = uiapp;
            //  this._uiapp = uiapp;
