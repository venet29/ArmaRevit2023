...
namespace ArmaduraLosaRevit.Model.REFUERZOLOSAS.WPFref
{
    ...
    /// </summary>
    public class EventHandlerWithWpfArg : RevitEventWrapper<Ui_barraRefuerzoLosa>
    {
        /// <summary>
        /// The Execute override void must be present in all methods wrapped by the RevitEventWrapper.
        /// This defines what the method will do when raised externally.
        /// </summary>
        public override void Execute(UIApplication uiApp, Ui_barraRefuerzoLosa ui_pelotaLosa)
        {
            // SETUP
     
            UIDocument uiDoc = uiApp.ActiveUIDocument;
            Document doc = uiDoc.Document;
            Methods_barraRefuerzo.M1_EjecutarRutinas(ui_pelotaLosa, uiApp);
