...
namespace ArmaduraLosaRevit.Model.REFUERZOLOSAS.WPFref
{
    ...
    public class ManejadorWPFref 
    {
        private TipoRefuerzoLOSA TipoLosa_;

        // ModelessForm instance
        private Ui_barraRefuerzoLosa _mMyForm;
        private UIApplication _UIapp;

        public ManejadorWPFref(ExternalCommandData commandData, TipoRefuerzoLOSA _TipoLosa_)
        {
            _UIapp = commandData.Application;
            this.TipoLosa_ = _TipoLosa_;
        }
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new Ui_barraRefuerzoLosa(uiapp, TipoLosa_, evStr, evWpf);
