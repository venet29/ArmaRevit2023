...
namespace ArmaduraLosaRevit.Model.Stairsnh.WPFesc
{
    ...
    public class ManejadorWPFesc 
    {
      
        // ModelessForm instance
        private Ui_barraEscaleras _mMyForm;
        private UIApplication _UIapp;

        public ManejadorWPFesc(ExternalCommandData commandData)
        {
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        public void ShowForm(UIApplication uiapp)
        {
            ...
            _mMyForm = new Ui_barraEscaleras(uiapp, evStr, evWpf);
