...
namespace ArmaduraLosaRevit.Model.Traslapo
{
    ...
    public class CmdCrearPathReinfomentTraslapoConPto : IExternalCommand
    {
        //double angle = 16.3;
        //angle = 16.3;
        ...
        public Autodesk.Revit.UI.Result Execute(ExternalCommandData revit, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            ...
            try
            {
                revit.Application.Application.FailuresProcessing += new EventHandler<FailuresProcessingEventArgs>(utilfallas.ProcesamientoFallas);

                SeleccionarPathReinfomentConPto seleccionarPathReinfomentConPto = new SeleccionarPathReinfomentConPto(uiapp);
                if (!seleccionarPathReinfomentConPto.SeleccionarPathReinforment()) return Result.Failed;

                //cargardatos
                PathReinformeTraslapoManejador pathReinformeTraslapo = new PathReinformeTraslapoManejador(uiapp, seleccionarPathReinfomentConPto);
