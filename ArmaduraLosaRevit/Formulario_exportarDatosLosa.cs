...
namespace ArmaduraLosaRevit
{
    ...
    public class Formulario_exportarDatosLosa : IExternalCommand
    {
        /// <summary>
        ...
        public Autodesk.Revit.UI.Result Execute(ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            try
            {
              ...
              // formulario.GetListaNH_RefereciaRoom();
    ...
    [Autodesk.Revit.Attributes.Transaction(Autodesk.Revit.Attributes.TransactionMode.Manual)]
    //[Autodesk.Revit.Attributes.Regeneration(Autodesk.Revit.Attributes.RegenerationOption.Manual)]
    public class Formulario_ImportatBarras_INFERIOR : IExternalCommand
    {
        /// <summary>
        /// clases barras para para definir las barras, para poder modificar las familias para luego dibujarlos
        /// en el mrevit
    ...
    [Autodesk.Revit.Attributes.Transaction(Autodesk.Revit.Attributes.TransactionMode.Manual)]
    //[Autodesk.Revit.Attributes.Regeneration(Autodesk.Revit.Attributes.RegenerationOption.Manual)]
    public class Formulario_ImportatBarras_SUPERIOR : IExternalCommand
    {
        /// <summary>
        /// clases barras para para definir las barras, para poder modificar las familias para luego dibujarlos
        /// en el mrevit
