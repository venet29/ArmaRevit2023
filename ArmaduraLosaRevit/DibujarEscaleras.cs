...
namespace ArmaduraLosaRevit
{
    ...
    public class ArmaduraEscalerarEscaleras : IExternalCommand
    {
    ...
    //[Autodesk.Revit.Attributes.Regeneration(Autodesk.Revit.Attributes.RegenerationOption.Manual)]
    //[Autodesk.Revit.Attributes.Journaling(Autodesk.Revit.Attributes.JournalingMode.UsingCommandData)]
    public class ArmaduraEscalerarBorrar : IExternalCommand
    {
        ...
        public Autodesk.Revit.UI.Result Execute(ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            ...
            BorrarRebarRectangulo.EjecutarEscalera(commandData.Application);
