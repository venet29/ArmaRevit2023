...
namespace ArmaduraLosaRevit
{
    class Util
    {
        ...
        //variables publicas que se cargan con el menu




        public static string m_nombreLosa_ = "";
        ...
        /// <summary>
        /// 25)Create 
        /// ation matrix to transform points 
    ...
    return e;
        ...
        public static bool GetSelectedElementsOrAll(List<Element> a, UIDocument uidoc, Type t)
        {
            ...
            if (0 < ids.Count)
            {
                a.AddRange(ids.Select<ElementId, Element>(id => doc.GetElement(id))
                  .Where<Element>(e => t.IsInstanceOfType(e)));
            }
            else
            {
        ...
        public static bool GetSelectedElementsOrAll(List<Element> a, UIDocument uidoc, Type t, Level level)
        {
            Document doc = uidoc.Document;
            ...
            if (0 < ids.Count)
            {
                a.AddRange(ids.Select<ElementId, Element>(id => doc.GetElement(id)).Where<Element>(e => t.IsInstanceOfType(e) && e.LevelId == level.LevelId));
            }
            else
            {
      ...
      return elementsByName.First<Element>();
        ...
        public class SpellingErrorCorrector
        {
            ...
            object NewExternalDefinitionCreationOptions(string name, ParameterType parameterType)
            {
    ...
    public static class CompatibilityMethods
    {
        ...
        /*
        public static Definition Create2(this Definitions definitions, Document doc, string nome, ParameterType tipo, bool visibilidade)
        {
            ...
            {
                value = definitions.GetType().GetMethod("Create", new Type[] { typeof(string), typeof(ParameterType), typeof(bool) })
